...
Redshift.prototype.query = function (query, options, callback) {
  ...
  else if(lastArg) throw new Error("Invalid function signature in aws-redshift query function");
...
Redshift.prototype.parameterizedQuery = function (query, parameters, options, callback) {
  ...
  // there's something but it's neither an object nor a function, so alert the user
  else if(lastArg) throw new Error("Invalid function signature in aws-redshift parameterizedQuery function");
...
Redshift.prototype.rawQuery = function(query, options, callback){
  ...
  // there's something but it's neither an object nor a function, so alert the user
  else if(lastArg) throw new Error("Invalid function signature in aws-redshift rawQuery function");
