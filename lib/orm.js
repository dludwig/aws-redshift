 ...
 *
 * Usage
 * Person.create({emailAddress: 'john@email.com', name: 'John'}, function(err, data){
 *   if(err) throw err;
 ...
 *
 * Usage
 * Person.update({id: 72}, {emailAddress: 'john@email.com', name: 'John'}, function(err, data){
 *   if(err) throw err;
 *   else console.log(data);
 * })
 */
 ...
 *
 * Usage
 * Person.delete({emailAddress: 'john@email.com', name: 'John'}, function(err, data){
 *   if(err) throw err;
 *   else console.log(data);
 * });
 */
